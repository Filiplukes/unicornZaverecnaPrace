...
exports.default = _react2.default.createClass({
  ...
  _handleLinkClick: function _handleLinkClick(link) {
    this._filterForm.getValues().dateFrom;

    this.getCcrComponentByKey(UU5.Environment.CCRKEY_ROUTER).setRoute(_react2.default.createElement(_order2.default, { car: link, to: this._filterForm.getValues().dateTo }));
  },
...
//# sourceMappingURL=0.7277f66b93ede0e68487.hot-update.js.map