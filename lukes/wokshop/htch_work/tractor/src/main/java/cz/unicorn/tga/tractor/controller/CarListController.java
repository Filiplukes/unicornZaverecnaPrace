...
public class CarListController {
	...
	@RequestMapping(value = "/rentFind", method = RequestMethod.GET)

	public CarDTO[] findForRent(final CarFilter carFilter) {


		final List<CarDTO> result = carService.findCarsForRent(carFilter);
